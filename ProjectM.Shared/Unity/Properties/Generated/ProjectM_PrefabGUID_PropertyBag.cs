...
namespace Unity.Properties.Generated
{
  public class ProjectM_PrefabGUID_PropertyBag : ContainerPropertyBag<PrefabGUID>
  {
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 804873, XrefRangeEnd = 804886, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    {
      Il2CppClassPointerStore<ProjectM_PrefabGUID_PropertyBag>.NativeClassPtr = IL2CPP.GetIl2CppClass("ProjectM.Shared.dll", "Unity.Properties.Generated", nameof (ProjectM_PrefabGUID_PropertyBag));
      ProjectM_PrefabGUID_PropertyBag.NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ProjectM_PrefabGUID_PropertyBag>.NativeClassPtr, 100671067);
    }
    ...
    public class GuidHash_Property : Property<PrefabGUID, int>
    {
      ...
      {
        [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 804866, XrefRangeEnd = 804868, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] get
        {
      ...
      [CallerCount(2)]
      [CachedScanResults(RefRangeStart = 804871, RefRangeEnd = 804873, XrefRangeStart = 804868, XrefRangeEnd = 804871, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
      ...
      static GuidHash_Property()
      {
        ...
        ProjectM_PrefabGUID_PropertyBag.GuidHash_Property.NativeMethodInfoPtr_get_Name_Public_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ProjectM_PrefabGUID_PropertyBag.GuidHash_Property>.NativeClassPtr, 100671068);
        ProjectM_PrefabGUID_PropertyBag.GuidHash_Property.NativeMethodInfoPtr_get_IsReadOnly_Public_Virtual_get_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ProjectM_PrefabGUID_PropertyBag.GuidHash_Property>.NativeClassPtr, 100671069);
        ProjectM_PrefabGUID_PropertyBag.GuidHash_Property.NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ProjectM_PrefabGUID_PropertyBag.GuidHash_Property>.NativeClassPtr, 100671070);
        ProjectM_PrefabGUID_PropertyBag.GuidHash_Property.NativeMethodInfoPtr_GetValue_Public_Virtual_Int32_byref_PrefabGUID_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ProjectM_PrefabGUID_PropertyBag.GuidHash_Property>.NativeClassPtr, 100671071);
        ProjectM_PrefabGUID_PropertyBag.GuidHash_Property.NativeMethodInfoPtr_SetValue_Public_Virtual_Void_byref_PrefabGUID_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ProjectM_PrefabGUID_PropertyBag.GuidHash_Property>.NativeClassPtr, 100671072);
      }
