...
namespace Unity.Properties.Generated
{
    ...
    ContainerPropertyBag<LocalizationKey>
  {
    ...
    [CallerCount(1)]
    [CachedScanResults(RefRangeStart = 1291580, RefRangeEnd = 1291581, XrefRangeStart = 1291567, XrefRangeEnd = 1291580, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    {
      Il2CppClassPointerStore<Stunlock_Localization_LocalizationKey_PropertyBag>.NativeClassPtr = IL2CPP.GetIl2CppClass("ProjectM.HUD.dll", "Unity.Properties.Generated", nameof (Stunlock_Localization_LocalizationKey_PropertyBag));
      Stunlock_Localization_LocalizationKey_PropertyBag.NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Stunlock_Localization_LocalizationKey_PropertyBag>.NativeClassPtr, 100669872);
    }
    ...
    public class Key_Property : Property<LocalizationKey, AssetGuid>
    {
      ...
      {
        [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1291561, XrefRangeEnd = 1291563, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] get
        {
      ...
      [CallerCount(1)]
      [CachedScanResults(RefRangeStart = 1291566, RefRangeEnd = 1291567, XrefRangeStart = 1291563, XrefRangeEnd = 1291566, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
      ...
      static Key_Property()
      {
        ...
        Stunlock_Localization_LocalizationKey_PropertyBag.Key_Property.NativeMethodInfoPtr_get_Name_Public_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Stunlock_Localization_LocalizationKey_PropertyBag.Key_Property>.NativeClassPtr, 100669873);
        Stunlock_Localization_LocalizationKey_PropertyBag.Key_Property.NativeMethodInfoPtr_get_IsReadOnly_Public_Virtual_get_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Stunlock_Localization_LocalizationKey_PropertyBag.Key_Property>.NativeClassPtr, 100669874);
        Stunlock_Localization_LocalizationKey_PropertyBag.Key_Property.NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Stunlock_Localization_LocalizationKey_PropertyBag.Key_Property>.NativeClassPtr, 100669875);
        Stunlock_Localization_LocalizationKey_PropertyBag.Key_Property.NativeMethodInfoPtr_GetValue_Public_Virtual_AssetGuid_byref_LocalizationKey_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Stunlock_Localization_LocalizationKey_PropertyBag.Key_Property>.NativeClassPtr, 100669876);
        Stunlock_Localization_LocalizationKey_PropertyBag.Key_Property.NativeMethodInfoPtr_SetValue_Public_Virtual_Void_byref_LocalizationKey_AssetGuid_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Stunlock_Localization_LocalizationKey_PropertyBag.Key_Property>.NativeClassPtr, 100669877);
      }
