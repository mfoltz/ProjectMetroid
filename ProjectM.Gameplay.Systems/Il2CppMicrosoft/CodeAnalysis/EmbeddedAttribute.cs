...
namespace Il2CppMicrosoft.CodeAnalysis
{
  public sealed class EmbeddedAttribute : Il2CppSystem.Attribute
  {
    ...
    {
      Il2CppClassPointerStore<EmbeddedAttribute>.NativeClassPtr = IL2CPP.GetIl2CppClass("ProjectM.Gameplay.Systems.dll", "Microsoft.CodeAnalysis", nameof (EmbeddedAttribute));
