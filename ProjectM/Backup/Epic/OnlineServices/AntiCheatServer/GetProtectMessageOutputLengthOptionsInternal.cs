...
namespace Epic.OnlineServices.AntiCheatServer
{
  ...
  public struct GetProtectMessageOutputLengthOptionsInternal
  {
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 969224, XrefRangeEnd = 969228, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    {
      Il2CppClassPointerStore<GetProtectMessageOutputLengthOptionsInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("ProjectM.dll", "Epic.OnlineServices.AntiCheatServer", nameof (GetProtectMessageOutputLengthOptionsInternal));
      ...
      GetProtectMessageOutputLengthOptionsInternal.NativeMethodInfoPtr_set_DataLengthBytes_Public_set_Void_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetProtectMessageOutputLengthOptionsInternal>.NativeClassPtr, 100673828);
      GetProtectMessageOutputLengthOptionsInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_byref_GetProtectMessageOutputLengthOptions_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetProtectMessageOutputLengthOptionsInternal>.NativeClassPtr, 100673829);
      GetProtectMessageOutputLengthOptionsInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_byref_Nullable_Unboxed_1_GetProtectMessageOutputLengthOptions_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetProtectMessageOutputLengthOptionsInternal>.NativeClassPtr, 100673830);
      GetProtectMessageOutputLengthOptionsInternal.NativeMethodInfoPtr_Dispose_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetProtectMessageOutputLengthOptionsInternal>.NativeClassPtr, 100673831);
    }
