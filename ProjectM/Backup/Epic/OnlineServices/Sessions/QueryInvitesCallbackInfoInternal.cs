...
namespace Epic.OnlineServices.Sessions
{
  ...
  public struct QueryInvitesCallbackInfoInternal
  {
    ...
    {
      [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 941130, XrefRangeEnd = 941134, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] get
      {
        System.IntPtr* numPtr = (System.IntPtr*) null;
        System.IntPtr exc;
      ...
      [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 941134, XrefRangeEnd = 941138, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
      {
        System.IntPtr* numPtr = stackalloc System.IntPtr[1];
    ...
    {
      [CallerCount(1), CachedScanResults(RefRangeStart = 941144, RefRangeEnd = 941145, XrefRangeStart = 941138, XrefRangeEnd = 941144, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] get
      {
        System.IntPtr* numPtr = (System.IntPtr*) null;
        System.IntPtr exc;
      ...
      [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 941145, XrefRangeEnd = 941149, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
      {
        System.IntPtr* numPtr = stackalloc System.IntPtr[1];
        numPtr[0] = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase) value);
        System.IntPtr exc;
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 941149, XrefRangeEnd = 941157, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 941157, XrefRangeEnd = 941173, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 941173, XrefRangeEnd = 941178, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 941178, XrefRangeEnd = 941179, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    {
      Il2CppClassPointerStore<QueryInvitesCallbackInfoInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("ProjectM.dll", "Epic.OnlineServices.Sessions", nameof (QueryInvitesCallbackInfoInternal));
      ...
      QueryInvitesCallbackInfoInternal.NativeMethodInfoPtr_get_ResultCode_Public_get_Result_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<QueryInvitesCallbackInfoInternal>.NativeClassPtr, 100666225);
      QueryInvitesCallbackInfoInternal.NativeMethodInfoPtr_set_ResultCode_Public_set_Void_Result_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<QueryInvitesCallbackInfoInternal>.NativeClassPtr, 100666226);
      QueryInvitesCallbackInfoInternal.NativeMethodInfoPtr_get_ClientData_Public_get_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<QueryInvitesCallbackInfoInternal>.NativeClassPtr, 100666227);
      QueryInvitesCallbackInfoInternal.NativeMethodInfoPtr_set_ClientData_Public_set_Void_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<QueryInvitesCallbackInfoInternal>.NativeClassPtr, 100666228);
      QueryInvitesCallbackInfoInternal.NativeMethodInfoPtr_get_ClientDataAddress_Public_Virtual_Final_New_get_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<QueryInvitesCallbackInfoInternal>.NativeClassPtr, 100666229);
      QueryInvitesCallbackInfoInternal.NativeMethodInfoPtr_get_LocalUserId_Public_get_ProductUserId_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<QueryInvitesCallbackInfoInternal>.NativeClassPtr, 100666230);
      QueryInvitesCallbackInfoInternal.NativeMethodInfoPtr_set_LocalUserId_Public_set_Void_ProductUserId_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<QueryInvitesCallbackInfoInternal>.NativeClassPtr, 100666231);
      QueryInvitesCallbackInfoInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_byref_QueryInvitesCallbackInfo_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<QueryInvitesCallbackInfoInternal>.NativeClassPtr, 100666232);
      QueryInvitesCallbackInfoInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_byref_Nullable_1_QueryInvitesCallbackInfo_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<QueryInvitesCallbackInfoInternal>.NativeClassPtr, 100666233);
      QueryInvitesCallbackInfoInternal.NativeMethodInfoPtr_Dispose_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<QueryInvitesCallbackInfoInternal>.NativeClassPtr, 100666234);
      QueryInvitesCallbackInfoInternal.NativeMethodInfoPtr_Get_Public_Virtual_Final_New_Void_byref_QueryInvitesCallbackInfo_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<QueryInvitesCallbackInfoInternal>.NativeClassPtr, 100666235);
    }
