...
namespace Epic.OnlineServices.PlayerDataStorage
{
  ...
  public struct FileTransferProgressCallbackInfoInternal
  {
    ...
    {
      [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 949619, XrefRangeEnd = 949623, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] get
      {
      ...
      [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 949623, XrefRangeEnd = 949627, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
      {
    ...
    {
      [CallerCount(1), CachedScanResults(RefRangeStart = 949633, RefRangeEnd = 949634, XrefRangeStart = 949627, XrefRangeEnd = 949633, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] get
      {
        System.IntPtr* numPtr = (System.IntPtr*) null;
        System.IntPtr exc;
      ...
      [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 949634, XrefRangeEnd = 949638, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
      {
        System.IntPtr* numPtr = stackalloc System.IntPtr[1];
        numPtr[0] = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase) value);
        System.IntPtr exc;
    ...
    {
      [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 949638, XrefRangeEnd = 949642, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] get
      {
        System.IntPtr* numPtr = (System.IntPtr*) null;
        System.IntPtr exc;
      ...
      [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 949642, XrefRangeEnd = 949646, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
      {
        System.IntPtr* numPtr = stackalloc System.IntPtr[1];
        numPtr[0] = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase) value);
        System.IntPtr exc;
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 949646, XrefRangeEnd = 949658, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 949658, XrefRangeEnd = 949682, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 949682, XrefRangeEnd = 949688, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 949688, XrefRangeEnd = 949689, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    {
      Il2CppClassPointerStore<FileTransferProgressCallbackInfoInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("ProjectM.dll", "Epic.OnlineServices.PlayerDataStorage", nameof (FileTransferProgressCallbackInfoInternal));
      ...
      FileTransferProgressCallbackInfoInternal.NativeMethodInfoPtr_get_ClientData_Public_get_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfoInternal>.NativeClassPtr, 100668503);
      FileTransferProgressCallbackInfoInternal.NativeMethodInfoPtr_set_ClientData_Public_set_Void_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfoInternal>.NativeClassPtr, 100668504);
      FileTransferProgressCallbackInfoInternal.NativeMethodInfoPtr_get_ClientDataAddress_Public_Virtual_Final_New_get_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfoInternal>.NativeClassPtr, 100668505);
      FileTransferProgressCallbackInfoInternal.NativeMethodInfoPtr_get_LocalUserId_Public_get_ProductUserId_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfoInternal>.NativeClassPtr, 100668506);
      FileTransferProgressCallbackInfoInternal.NativeMethodInfoPtr_set_LocalUserId_Public_set_Void_ProductUserId_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfoInternal>.NativeClassPtr, 100668507);
      FileTransferProgressCallbackInfoInternal.NativeMethodInfoPtr_get_Filename_Public_get_Utf8String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfoInternal>.NativeClassPtr, 100668508);
      FileTransferProgressCallbackInfoInternal.NativeMethodInfoPtr_set_Filename_Public_set_Void_Utf8String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfoInternal>.NativeClassPtr, 100668509);
      FileTransferProgressCallbackInfoInternal.NativeMethodInfoPtr_get_BytesTransferred_Public_get_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfoInternal>.NativeClassPtr, 100668510);
      FileTransferProgressCallbackInfoInternal.NativeMethodInfoPtr_set_BytesTransferred_Public_set_Void_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfoInternal>.NativeClassPtr, 100668511);
      FileTransferProgressCallbackInfoInternal.NativeMethodInfoPtr_get_TotalFileSizeBytes_Public_get_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfoInternal>.NativeClassPtr, 100668512);
      FileTransferProgressCallbackInfoInternal.NativeMethodInfoPtr_set_TotalFileSizeBytes_Public_set_Void_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfoInternal>.NativeClassPtr, 100668513);
      FileTransferProgressCallbackInfoInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_byref_FileTransferProgressCallbackInfo_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfoInternal>.NativeClassPtr, 100668514);
      FileTransferProgressCallbackInfoInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_byref_Nullable_1_FileTransferProgressCallbackInfo_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfoInternal>.NativeClassPtr, 100668515);
      FileTransferProgressCallbackInfoInternal.NativeMethodInfoPtr_Dispose_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfoInternal>.NativeClassPtr, 100668516);
      FileTransferProgressCallbackInfoInternal.NativeMethodInfoPtr_Get_Public_Virtual_Final_New_Void_byref_FileTransferProgressCallbackInfo_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfoInternal>.NativeClassPtr, 100668517);
    }
