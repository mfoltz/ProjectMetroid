...
namespace Epic.OnlineServices.PlayerDataStorage
{
  public sealed class OnDeleteCacheCompleteCallback : Il2CppSystem.MulticastDelegate
  {
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 949710, XrefRangeEnd = 949714, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    {
      Il2CppClassPointerStore<OnDeleteCacheCompleteCallback>.NativeClassPtr = IL2CPP.GetIl2CppClass("ProjectM.dll", "Epic.OnlineServices.PlayerDataStorage", nameof (OnDeleteCacheCompleteCallback));
      OnDeleteCacheCompleteCallback.NativeMethodInfoPtr__ctor_Public_Void_Object_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnDeleteCacheCompleteCallback>.NativeClassPtr, 100668524);
      OnDeleteCacheCompleteCallback.NativeMethodInfoPtr_Invoke_Public_Virtual_New_Void_byref_DeleteCacheCallbackInfo_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnDeleteCacheCompleteCallback>.NativeClassPtr, 100668525);
      OnDeleteCacheCompleteCallback.NativeMethodInfoPtr_BeginInvoke_Public_Virtual_New_IAsyncResult_byref_DeleteCacheCallbackInfo_AsyncCallback_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnDeleteCacheCompleteCallback>.NativeClassPtr, 100668526);
      OnDeleteCacheCompleteCallback.NativeMethodInfoPtr_EndInvoke_Public_Virtual_New_Void_byref_DeleteCacheCallbackInfo_IAsyncResult_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnDeleteCacheCompleteCallback>.NativeClassPtr, 100668527);
    }
