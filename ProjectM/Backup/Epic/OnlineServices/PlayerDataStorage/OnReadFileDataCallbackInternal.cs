...
namespace Epic.OnlineServices.PlayerDataStorage
{
  public sealed class OnReadFileDataCallbackInternal : Il2CppSystem.MulticastDelegate
  {
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 949770, XrefRangeEnd = 949774, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    {
      Il2CppClassPointerStore<OnReadFileDataCallbackInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("ProjectM.dll", "Epic.OnlineServices.PlayerDataStorage", nameof (OnReadFileDataCallbackInternal));
      OnReadFileDataCallbackInternal.NativeMethodInfoPtr__ctor_Public_Void_Object_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnReadFileDataCallbackInternal>.NativeClassPtr, 100668584);
      OnReadFileDataCallbackInternal.NativeMethodInfoPtr_Invoke_Public_Virtual_New_ReadResult_byref_ReadFileDataCallbackInfoInternal_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnReadFileDataCallbackInternal>.NativeClassPtr, 100668585);
      OnReadFileDataCallbackInternal.NativeMethodInfoPtr_BeginInvoke_Public_Virtual_New_IAsyncResult_byref_ReadFileDataCallbackInfoInternal_AsyncCallback_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnReadFileDataCallbackInternal>.NativeClassPtr, 100668586);
      OnReadFileDataCallbackInternal.NativeMethodInfoPtr_EndInvoke_Public_Virtual_New_ReadResult_byref_ReadFileDataCallbackInfoInternal_IAsyncResult_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnReadFileDataCallbackInternal>.NativeClassPtr, 100668587);
    }
