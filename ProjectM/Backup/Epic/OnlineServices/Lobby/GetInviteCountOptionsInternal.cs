...
namespace Epic.OnlineServices.Lobby
{
  ...
  public struct GetInviteCountOptionsInternal
  {
    ...
    {
      [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 954490, XrefRangeEnd = 954494, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
      {
    ...
    [CallerCount(1)]
    [CachedScanResults(RefRangeStart = 954498, RefRangeEnd = 954499, XrefRangeStart = 954494, XrefRangeEnd = 954498, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 954499, XrefRangeEnd = 954507, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 954507, XrefRangeEnd = 954511, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    {
      Il2CppClassPointerStore<GetInviteCountOptionsInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("ProjectM.dll", "Epic.OnlineServices.Lobby", nameof (GetInviteCountOptionsInternal));
      ...
      GetInviteCountOptionsInternal.NativeMethodInfoPtr_set_LocalUserId_Public_set_Void_ProductUserId_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetInviteCountOptionsInternal>.NativeClassPtr, 100669785);
      GetInviteCountOptionsInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_byref_GetInviteCountOptions_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetInviteCountOptionsInternal>.NativeClassPtr, 100669786);
      GetInviteCountOptionsInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_byref_Nullable_1_GetInviteCountOptions_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetInviteCountOptionsInternal>.NativeClassPtr, 100669787);
      GetInviteCountOptionsInternal.NativeMethodInfoPtr_Dispose_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetInviteCountOptionsInternal>.NativeClassPtr, 100669788);
    }
