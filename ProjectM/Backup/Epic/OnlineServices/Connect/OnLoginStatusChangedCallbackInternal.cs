...
namespace Epic.OnlineServices.Connect
{
  public sealed class OnLoginStatusChangedCallbackInternal : Il2CppSystem.MulticastDelegate
  {
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 966145, XrefRangeEnd = 966149, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    {
      Il2CppClassPointerStore<OnLoginStatusChangedCallbackInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("ProjectM.dll", "Epic.OnlineServices.Connect", nameof (OnLoginStatusChangedCallbackInternal));
      OnLoginStatusChangedCallbackInternal.NativeMethodInfoPtr__ctor_Public_Void_Object_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnLoginStatusChangedCallbackInternal>.NativeClassPtr, 100673004);
      OnLoginStatusChangedCallbackInternal.NativeMethodInfoPtr_Invoke_Public_Virtual_New_Void_byref_LoginStatusChangedCallbackInfoInternal_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnLoginStatusChangedCallbackInternal>.NativeClassPtr, 100673005);
      OnLoginStatusChangedCallbackInternal.NativeMethodInfoPtr_BeginInvoke_Public_Virtual_New_IAsyncResult_byref_LoginStatusChangedCallbackInfoInternal_AsyncCallback_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnLoginStatusChangedCallbackInternal>.NativeClassPtr, 100673006);
      OnLoginStatusChangedCallbackInternal.NativeMethodInfoPtr_EndInvoke_Public_Virtual_New_Void_byref_LoginStatusChangedCallbackInfoInternal_IAsyncResult_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnLoginStatusChangedCallbackInternal>.NativeClassPtr, 100673007);
    }
