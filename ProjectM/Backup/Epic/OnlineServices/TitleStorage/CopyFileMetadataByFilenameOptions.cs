...
namespace Epic.OnlineServices.TitleStorage
{
  public sealed class CopyFileMetadataByFilenameOptions : Il2CppSystem.ValueType
  {
    ...
    {
      Il2CppClassPointerStore<CopyFileMetadataByFilenameOptions>.NativeClassPtr = IL2CPP.GetIl2CppClass("ProjectM.dll", "Epic.OnlineServices.TitleStorage", nameof (CopyFileMetadataByFilenameOptions));
      ...
      CopyFileMetadataByFilenameOptions.NativeMethodInfoPtr_get_LocalUserId_Public_get_ProductUserId_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CopyFileMetadataByFilenameOptions>.NativeClassPtr, 100665401);
      CopyFileMetadataByFilenameOptions.NativeMethodInfoPtr_set_LocalUserId_Public_set_Void_ProductUserId_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CopyFileMetadataByFilenameOptions>.NativeClassPtr, 100665402);
      CopyFileMetadataByFilenameOptions.NativeMethodInfoPtr_get_Filename_Public_get_Utf8String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CopyFileMetadataByFilenameOptions>.NativeClassPtr, 100665403);
      CopyFileMetadataByFilenameOptions.NativeMethodInfoPtr_set_Filename_Public_set_Void_Utf8String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CopyFileMetadataByFilenameOptions>.NativeClassPtr, 100665404);
    }
