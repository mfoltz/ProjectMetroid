...
namespace Epic.OnlineServices.TitleStorage
{
  public sealed class ReadFileOptions : Il2CppSystem.ValueType
  {
    ...
    {
      Il2CppClassPointerStore<ReadFileOptions>.NativeClassPtr = IL2CPP.GetIl2CppClass("ProjectM.dll", "Epic.OnlineServices.TitleStorage", nameof (ReadFileOptions));
      ...
      ReadFileOptions.NativeMethodInfoPtr_get_LocalUserId_Public_get_ProductUserId_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptions>.NativeClassPtr, 100665651);
      ReadFileOptions.NativeMethodInfoPtr_set_LocalUserId_Public_set_Void_ProductUserId_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptions>.NativeClassPtr, 100665652);
      ReadFileOptions.NativeMethodInfoPtr_get_Filename_Public_get_Utf8String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptions>.NativeClassPtr, 100665653);
      ReadFileOptions.NativeMethodInfoPtr_set_Filename_Public_set_Void_Utf8String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptions>.NativeClassPtr, 100665654);
      ReadFileOptions.NativeMethodInfoPtr_get_ReadChunkLengthBytes_Public_get_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptions>.NativeClassPtr, 100665655);
      ReadFileOptions.NativeMethodInfoPtr_set_ReadChunkLengthBytes_Public_set_Void_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptions>.NativeClassPtr, 100665656);
      ReadFileOptions.NativeMethodInfoPtr_get_ReadFileDataCallback_Public_get_OnReadFileDataCallback_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptions>.NativeClassPtr, 100665657);
      ReadFileOptions.NativeMethodInfoPtr_set_ReadFileDataCallback_Public_set_Void_OnReadFileDataCallback_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptions>.NativeClassPtr, 100665658);
      ReadFileOptions.NativeMethodInfoPtr_get_FileTransferProgressCallback_Public_get_OnFileTransferProgressCallback_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptions>.NativeClassPtr, 100665659);
      ReadFileOptions.NativeMethodInfoPtr_set_FileTransferProgressCallback_Public_set_Void_OnFileTransferProgressCallback_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptions>.NativeClassPtr, 100665660);
    }
