...
namespace Epic.OnlineServices.TitleStorage
{
  public sealed class OnReadFileDataCallback : Il2CppSystem.MulticastDelegate
  {
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 938648, XrefRangeEnd = 938652, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    {
      Il2CppClassPointerStore<OnReadFileDataCallback>.NativeClassPtr = IL2CPP.GetIl2CppClass("ProjectM.dll", "Epic.OnlineServices.TitleStorage", nameof (OnReadFileDataCallback));
      OnReadFileDataCallback.NativeMethodInfoPtr__ctor_Public_Void_Object_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnReadFileDataCallback>.NativeClassPtr, 100665529);
      OnReadFileDataCallback.NativeMethodInfoPtr_Invoke_Public_Virtual_New_ReadResult_byref_ReadFileDataCallbackInfo_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnReadFileDataCallback>.NativeClassPtr, 100665530);
      OnReadFileDataCallback.NativeMethodInfoPtr_BeginInvoke_Public_Virtual_New_IAsyncResult_byref_ReadFileDataCallbackInfo_AsyncCallback_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnReadFileDataCallback>.NativeClassPtr, 100665531);
      OnReadFileDataCallback.NativeMethodInfoPtr_EndInvoke_Public_Virtual_New_ReadResult_byref_ReadFileDataCallbackInfo_IAsyncResult_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnReadFileDataCallback>.NativeClassPtr, 100665532);
    }
