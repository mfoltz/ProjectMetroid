  ...
  public sealed class VerifyIdTokenOptions : Il2CppSystem.ValueType
  {
    ...
    public unsafe Il2CppSystem.Nullable<Epic.OnlineServices.Auth.IdToken> IdToken
    {
      [CallerCount(2), CachedScanResults(RefRangeStart = 242918, RefRangeEnd = 242920, XrefRangeStart = 242918, XrefRangeEnd = 242920, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] get
      {
        ...
        return new Il2CppSystem.Nullable<Epic.OnlineServices.Auth.IdToken>(pointer);
      }
    ...
    {
      Il2CppClassPointerStore<VerifyIdTokenOptions>.NativeClassPtr = IL2CPP.GetIl2CppClass("ProjectM.dll", "Epic.OnlineServices.Auth", nameof (VerifyIdTokenOptions));
      ...
      VerifyIdTokenOptions.NativeMethodInfoPtr_get_IdToken_Public_get_Nullable_1_IdToken_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VerifyIdTokenOptions>.NativeClassPtr, 100673696);
      VerifyIdTokenOptions.NativeMethodInfoPtr_set_IdToken_Public_set_Void_Nullable_1_IdToken_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VerifyIdTokenOptions>.NativeClassPtr, 100673697);
    }
    ...
    public Il2CppSystem.Nullable<Epic.OnlineServices.Auth.IdToken> _IdToken_k__BackingField
    {
      get
      {
        ...
        return new Il2CppSystem.Nullable<Epic.OnlineServices.Auth.IdToken>(IL2CPP.il2cpp_value_box(Il2CppClassPointerStore<Il2CppSystem.Nullable<Epic.OnlineServices.Auth.IdToken>>.NativeClassPtr, data));
      }
      [param: In] set
      {
        __memcpy(IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase) this) + (int) IL2CPP.il2cpp_field_get_offset(VerifyIdTokenOptions.NativeFieldInfoPtr__IdToken_k__BackingField), IL2CPP.il2cpp_object_unbox(IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase) value)), IL2CPP.il2cpp_class_value_size(Il2CppClassPointerStore<Il2CppSystem.Nullable<Epic.OnlineServices.Auth.IdToken>>.NativeClassPtr, (uint&) System.IntPtr.Zero));
      }
    }
  }
}
