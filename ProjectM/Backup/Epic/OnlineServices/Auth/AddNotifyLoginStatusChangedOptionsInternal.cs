...
namespace Epic.OnlineServices.Auth
{
  ...
  public struct AddNotifyLoginStatusChangedOptionsInternal
  {
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 966916, XrefRangeEnd = 966917, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    {
      Il2CppClassPointerStore<AddNotifyLoginStatusChangedOptionsInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("ProjectM.dll", "Epic.OnlineServices.Auth", nameof (AddNotifyLoginStatusChangedOptionsInternal));
      ...
      AddNotifyLoginStatusChangedOptionsInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_byref_AddNotifyLoginStatusChangedOptions_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AddNotifyLoginStatusChangedOptionsInternal>.NativeClassPtr, 100673245);
      AddNotifyLoginStatusChangedOptionsInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_byref_Nullable_Unboxed_1_AddNotifyLoginStatusChangedOptions_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AddNotifyLoginStatusChangedOptionsInternal>.NativeClassPtr, 100673246);
      AddNotifyLoginStatusChangedOptionsInternal.NativeMethodInfoPtr_Dispose_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AddNotifyLoginStatusChangedOptionsInternal>.NativeClassPtr, 100673247);
    }
