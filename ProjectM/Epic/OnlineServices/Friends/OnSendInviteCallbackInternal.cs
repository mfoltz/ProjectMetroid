...
namespace Epic.OnlineServices.Friends
{
  public sealed class OnSendInviteCallbackInternal : Il2CppSystem.MulticastDelegate
  {
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 960863, XrefRangeEnd = 960867, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    {
      Il2CppClassPointerStore<OnSendInviteCallbackInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("ProjectM.dll", "Epic.OnlineServices.Friends", nameof (OnSendInviteCallbackInternal));
      OnSendInviteCallbackInternal.NativeMethodInfoPtr__ctor_Public_Void_Object_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnSendInviteCallbackInternal>.NativeClassPtr, 100671578);
      OnSendInviteCallbackInternal.NativeMethodInfoPtr_Invoke_Public_Virtual_New_Void_byref_SendInviteCallbackInfoInternal_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnSendInviteCallbackInternal>.NativeClassPtr, 100671579);
      OnSendInviteCallbackInternal.NativeMethodInfoPtr_BeginInvoke_Public_Virtual_New_IAsyncResult_byref_SendInviteCallbackInfoInternal_AsyncCallback_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnSendInviteCallbackInternal>.NativeClassPtr, 100671580);
      OnSendInviteCallbackInternal.NativeMethodInfoPtr_EndInvoke_Public_Virtual_New_Void_byref_SendInviteCallbackInfoInternal_IAsyncResult_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnSendInviteCallbackInternal>.NativeClassPtr, 100671581);
    }
