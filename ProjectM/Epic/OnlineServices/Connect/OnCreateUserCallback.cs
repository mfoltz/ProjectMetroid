...
namespace Epic.OnlineServices.Connect
{
  public sealed class OnCreateUserCallback : Il2CppSystem.MulticastDelegate
  {
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 966109, XrefRangeEnd = 966113, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    {
      Il2CppClassPointerStore<OnCreateUserCallback>.NativeClassPtr = IL2CPP.GetIl2CppClass("ProjectM.dll", "Epic.OnlineServices.Connect", nameof (OnCreateUserCallback));
      OnCreateUserCallback.NativeMethodInfoPtr__ctor_Public_Void_Object_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnCreateUserCallback>.NativeClassPtr, 100672968);
      OnCreateUserCallback.NativeMethodInfoPtr_Invoke_Public_Virtual_New_Void_byref_CreateUserCallbackInfo_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnCreateUserCallback>.NativeClassPtr, 100672969);
      OnCreateUserCallback.NativeMethodInfoPtr_BeginInvoke_Public_Virtual_New_IAsyncResult_byref_CreateUserCallbackInfo_AsyncCallback_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnCreateUserCallback>.NativeClassPtr, 100672970);
      OnCreateUserCallback.NativeMethodInfoPtr_EndInvoke_Public_Virtual_New_Void_byref_CreateUserCallbackInfo_IAsyncResult_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnCreateUserCallback>.NativeClassPtr, 100672971);
    }
