...
namespace Epic.OnlineServices.TitleStorage
{
  ...
  public struct DeleteCacheOptionsInternal
  {
    ...
    {
      [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 938424, XrefRangeEnd = 938428, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
      {
    ...
    [CallerCount(1)]
    [CachedScanResults(RefRangeStart = 938432, RefRangeEnd = 938433, XrefRangeStart = 938428, XrefRangeEnd = 938432, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 938433, XrefRangeEnd = 938441, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 938441, XrefRangeEnd = 938445, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    {
      Il2CppClassPointerStore<DeleteCacheOptionsInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("ProjectM.dll", "Epic.OnlineServices.TitleStorage", nameof (DeleteCacheOptionsInternal));
      ...
      DeleteCacheOptionsInternal.NativeMethodInfoPtr_set_LocalUserId_Public_set_Void_ProductUserId_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DeleteCacheOptionsInternal>.NativeClassPtr, 100665431);
      DeleteCacheOptionsInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_byref_DeleteCacheOptions_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DeleteCacheOptionsInternal>.NativeClassPtr, 100665432);
      DeleteCacheOptionsInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_byref_Nullable_1_DeleteCacheOptions_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DeleteCacheOptionsInternal>.NativeClassPtr, 100665433);
      DeleteCacheOptionsInternal.NativeMethodInfoPtr_Dispose_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DeleteCacheOptionsInternal>.NativeClassPtr, 100665434);
    }
