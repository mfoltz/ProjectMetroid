...
namespace Epic.OnlineServices.TitleStorage
{
  ...
  public struct CopyFileMetadataAtIndexOptionsInternal
  {
    ...
    {
      [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 938305, XrefRangeEnd = 938309, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
      {
    ...
    [CallerCount(1)]
    [CachedScanResults(RefRangeStart = 938313, RefRangeEnd = 938314, XrefRangeStart = 938309, XrefRangeEnd = 938313, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 938314, XrefRangeEnd = 938324, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 938324, XrefRangeEnd = 938328, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    {
      Il2CppClassPointerStore<CopyFileMetadataAtIndexOptionsInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("ProjectM.dll", "Epic.OnlineServices.TitleStorage", nameof (CopyFileMetadataAtIndexOptionsInternal));
      ...
      CopyFileMetadataAtIndexOptionsInternal.NativeMethodInfoPtr_set_LocalUserId_Public_set_Void_ProductUserId_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CopyFileMetadataAtIndexOptionsInternal>.NativeClassPtr, 100665396);
      CopyFileMetadataAtIndexOptionsInternal.NativeMethodInfoPtr_set_Index_Public_set_Void_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CopyFileMetadataAtIndexOptionsInternal>.NativeClassPtr, 100665397);
      CopyFileMetadataAtIndexOptionsInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_byref_CopyFileMetadataAtIndexOptions_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CopyFileMetadataAtIndexOptionsInternal>.NativeClassPtr, 100665398);
      CopyFileMetadataAtIndexOptionsInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_byref_Nullable_1_CopyFileMetadataAtIndexOptions_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CopyFileMetadataAtIndexOptionsInternal>.NativeClassPtr, 100665399);
      CopyFileMetadataAtIndexOptionsInternal.NativeMethodInfoPtr_Dispose_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CopyFileMetadataAtIndexOptionsInternal>.NativeClassPtr, 100665400);
    }
