...
namespace Epic.OnlineServices.TitleStorage
{
  ...
  public struct GetFileMetadataCountOptionsInternal
  {
    ...
    {
      [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 938587, XrefRangeEnd = 938591, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
      {
    ...
    [CallerCount(1)]
    [CachedScanResults(RefRangeStart = 938595, RefRangeEnd = 938596, XrefRangeStart = 938591, XrefRangeEnd = 938595, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 938596, XrefRangeEnd = 938604, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 938604, XrefRangeEnd = 938608, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    {
      Il2CppClassPointerStore<GetFileMetadataCountOptionsInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("ProjectM.dll", "Epic.OnlineServices.TitleStorage", nameof (GetFileMetadataCountOptionsInternal));
      ...
      GetFileMetadataCountOptionsInternal.NativeMethodInfoPtr_set_LocalUserId_Public_set_Void_ProductUserId_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetFileMetadataCountOptionsInternal>.NativeClassPtr, 100665485);
      GetFileMetadataCountOptionsInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_byref_GetFileMetadataCountOptions_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetFileMetadataCountOptionsInternal>.NativeClassPtr, 100665486);
      GetFileMetadataCountOptionsInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_byref_Nullable_1_GetFileMetadataCountOptions_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetFileMetadataCountOptionsInternal>.NativeClassPtr, 100665487);
      GetFileMetadataCountOptionsInternal.NativeMethodInfoPtr_Dispose_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetFileMetadataCountOptionsInternal>.NativeClassPtr, 100665488);
    }
