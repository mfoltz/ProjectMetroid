...
namespace Epic.OnlineServices.TitleStorage
{
  public sealed class OnQueryFileListCompleteCallback : Il2CppSystem.MulticastDelegate
  {
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 938632, XrefRangeEnd = 938636, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    {
      Il2CppClassPointerStore<OnQueryFileListCompleteCallback>.NativeClassPtr = IL2CPP.GetIl2CppClass("ProjectM.dll", "Epic.OnlineServices.TitleStorage", nameof (OnQueryFileListCompleteCallback));
      OnQueryFileListCompleteCallback.NativeMethodInfoPtr__ctor_Public_Void_Object_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnQueryFileListCompleteCallback>.NativeClassPtr, 100665513);
      OnQueryFileListCompleteCallback.NativeMethodInfoPtr_Invoke_Public_Virtual_New_Void_byref_QueryFileListCallbackInfo_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnQueryFileListCompleteCallback>.NativeClassPtr, 100665514);
      OnQueryFileListCompleteCallback.NativeMethodInfoPtr_BeginInvoke_Public_Virtual_New_IAsyncResult_byref_QueryFileListCallbackInfo_AsyncCallback_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnQueryFileListCompleteCallback>.NativeClassPtr, 100665515);
      OnQueryFileListCompleteCallback.NativeMethodInfoPtr_EndInvoke_Public_Virtual_New_Void_byref_QueryFileListCallbackInfo_IAsyncResult_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnQueryFileListCompleteCallback>.NativeClassPtr, 100665516);
    }
