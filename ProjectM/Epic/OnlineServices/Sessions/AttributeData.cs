...
namespace Epic.OnlineServices.Sessions
{
  public sealed class AttributeData : Il2CppSystem.ValueType
  {
    ...
    public unsafe AttributeDataValue Value
    {
      ...
      [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 940068, XrefRangeEnd = 940069, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
      {
        IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase) this);
        System.IntPtr* numPtr = stackalloc System.IntPtr[1];
    ...
    [CallerCount(1)]
    [CachedScanResults(RefRangeStart = 940081, RefRangeEnd = 940082, XrefRangeStart = 940069, XrefRangeEnd = 940081, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    {
      Il2CppClassPointerStore<AttributeData>.NativeClassPtr = IL2CPP.GetIl2CppClass("ProjectM.dll", "Epic.OnlineServices.Sessions", nameof (AttributeData));
      ...
      AttributeData.NativeMethodInfoPtr_get_Key_Public_get_Utf8String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AttributeData>.NativeClassPtr, 100665897);
      AttributeData.NativeMethodInfoPtr_set_Key_Public_set_Void_Utf8String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AttributeData>.NativeClassPtr, 100665898);
      AttributeData.NativeMethodInfoPtr_get_Value_Public_get_AttributeDataValue_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AttributeData>.NativeClassPtr, 100665899);
      AttributeData.NativeMethodInfoPtr_set_Value_Public_set_Void_AttributeDataValue_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AttributeData>.NativeClassPtr, 100665900);
      AttributeData.NativeMethodInfoPtr_Set_Internal_Void_byref_AttributeDataInternal_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AttributeData>.NativeClassPtr, 100665901);
    }
