...
namespace Epic.OnlineServices.Auth
{
  public sealed class OnLoginCallbackInternal : Il2CppSystem.MulticastDelegate
  {
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 967956, XrefRangeEnd = 967960, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    {
      Il2CppClassPointerStore<OnLoginCallbackInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("ProjectM.dll", "Epic.OnlineServices.Auth", nameof (OnLoginCallbackInternal));
      OnLoginCallbackInternal.NativeMethodInfoPtr__ctor_Public_Void_Object_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnLoginCallbackInternal>.NativeClassPtr, 100673495);
      OnLoginCallbackInternal.NativeMethodInfoPtr_Invoke_Public_Virtual_New_Void_byref_LoginCallbackInfoInternal_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnLoginCallbackInternal>.NativeClassPtr, 100673496);
      OnLoginCallbackInternal.NativeMethodInfoPtr_BeginInvoke_Public_Virtual_New_IAsyncResult_byref_LoginCallbackInfoInternal_AsyncCallback_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnLoginCallbackInternal>.NativeClassPtr, 100673497);
      OnLoginCallbackInternal.NativeMethodInfoPtr_EndInvoke_Public_Virtual_New_Void_byref_LoginCallbackInfoInternal_IAsyncResult_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnLoginCallbackInternal>.NativeClassPtr, 100673498);
    }
