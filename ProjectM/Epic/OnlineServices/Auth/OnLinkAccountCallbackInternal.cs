...
namespace Epic.OnlineServices.Auth
{
  public sealed class OnLinkAccountCallbackInternal : Il2CppSystem.MulticastDelegate
  {
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 967948, XrefRangeEnd = 967952, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    {
      Il2CppClassPointerStore<OnLinkAccountCallbackInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("ProjectM.dll", "Epic.OnlineServices.Auth", nameof (OnLinkAccountCallbackInternal));
      OnLinkAccountCallbackInternal.NativeMethodInfoPtr__ctor_Public_Void_Object_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnLinkAccountCallbackInternal>.NativeClassPtr, 100673487);
      OnLinkAccountCallbackInternal.NativeMethodInfoPtr_Invoke_Public_Virtual_New_Void_byref_LinkAccountCallbackInfoInternal_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnLinkAccountCallbackInternal>.NativeClassPtr, 100673488);
      OnLinkAccountCallbackInternal.NativeMethodInfoPtr_BeginInvoke_Public_Virtual_New_IAsyncResult_byref_LinkAccountCallbackInfoInternal_AsyncCallback_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnLinkAccountCallbackInternal>.NativeClassPtr, 100673489);
      OnLinkAccountCallbackInternal.NativeMethodInfoPtr_EndInvoke_Public_Virtual_New_Void_byref_LinkAccountCallbackInfoInternal_IAsyncResult_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnLinkAccountCallbackInternal>.NativeClassPtr, 100673490);
    }
