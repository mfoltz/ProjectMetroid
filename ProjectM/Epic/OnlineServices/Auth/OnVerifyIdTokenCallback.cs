...
namespace Epic.OnlineServices.Auth
{
  public sealed class OnVerifyIdTokenCallback : Il2CppSystem.MulticastDelegate
  {
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 967984, XrefRangeEnd = 967988, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    {
      Il2CppClassPointerStore<OnVerifyIdTokenCallback>.NativeClassPtr = IL2CPP.GetIl2CppClass("ProjectM.dll", "Epic.OnlineServices.Auth", nameof (OnVerifyIdTokenCallback));
      OnVerifyIdTokenCallback.NativeMethodInfoPtr__ctor_Public_Void_Object_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnVerifyIdTokenCallback>.NativeClassPtr, 100673523);
      OnVerifyIdTokenCallback.NativeMethodInfoPtr_Invoke_Public_Virtual_New_Void_byref_VerifyIdTokenCallbackInfo_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnVerifyIdTokenCallback>.NativeClassPtr, 100673524);
      OnVerifyIdTokenCallback.NativeMethodInfoPtr_BeginInvoke_Public_Virtual_New_IAsyncResult_byref_VerifyIdTokenCallbackInfo_AsyncCallback_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnVerifyIdTokenCallback>.NativeClassPtr, 100673525);
      OnVerifyIdTokenCallback.NativeMethodInfoPtr_EndInvoke_Public_Virtual_New_Void_byref_VerifyIdTokenCallbackInfo_IAsyncResult_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnVerifyIdTokenCallback>.NativeClassPtr, 100673526);
    }
