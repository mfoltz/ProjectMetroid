...
namespace Epic.OnlineServices.PlayerDataStorage
{
  public sealed class OnReadFileCompleteCallback : Il2CppSystem.MulticastDelegate
  {
    ...
    [CallerCount(0)]
    [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 949758, XrefRangeEnd = 949762, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
    ...
    {
      Il2CppClassPointerStore<OnReadFileCompleteCallback>.NativeClassPtr = IL2CPP.GetIl2CppClass("ProjectM.dll", "Epic.OnlineServices.PlayerDataStorage", nameof (OnReadFileCompleteCallback));
      OnReadFileCompleteCallback.NativeMethodInfoPtr__ctor_Public_Void_Object_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnReadFileCompleteCallback>.NativeClassPtr, 100668572);
      OnReadFileCompleteCallback.NativeMethodInfoPtr_Invoke_Public_Virtual_New_Void_byref_ReadFileCallbackInfo_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnReadFileCompleteCallback>.NativeClassPtr, 100668573);
      OnReadFileCompleteCallback.NativeMethodInfoPtr_BeginInvoke_Public_Virtual_New_IAsyncResult_byref_ReadFileCallbackInfo_AsyncCallback_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnReadFileCompleteCallback>.NativeClassPtr, 100668574);
      OnReadFileCompleteCallback.NativeMethodInfoPtr_EndInvoke_Public_Virtual_New_Void_byref_ReadFileCallbackInfo_IAsyncResult_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnReadFileCompleteCallback>.NativeClassPtr, 100668575);
    }
